...
--
-- Host: 127.0.0.1:3306
-- Generation Time: May 31, 2022 at 10:56 AM
...
ALTER TABLE `appointment`
  ADD CONSTRAINT `appointment_ibfk_1` FOREIGN KEY (`dr_id`) REFERENCES `doctor` (`dr_id`) ON DELETE NO ACTION ON UPDATE NO ACTION,
  ADD CONSTRAINT `appointment_ibfk_2` FOREIGN KEY (`P_id`) REFERENCES `patient` (`P_id`) ON DELETE NO ACTION ON UPDATE NO ACTION;
